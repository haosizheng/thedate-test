    ...
    <Layout>
      <div className="content">
        ...
        <div className="faq__item">
          ...
          <p>Since <a href="https://en.wikipedia.org/wiki/Unix_time">Unix Epoch</a>, one The Date was generated each earth day. </p>
        ...
        <div className="faq__item">
          ...
          <p>
            ...
            Select an available date to claim, and note that only one The Date will be available for each date. Each initial claim costs Ξ 0.01.
          </p>
          <p>
        ...
        <div className="faq__item">
          ...
          <p>
            ...
            However, youhave to pay Ξ 0.1 <a href={`${etherscanLinkOfToken}#writeContract`}>erase</a> the existing engraved note before a new one can be engraved. 
          </p>
        </div>
        ...
        <div className="faq__item">
          ...
          <p>
            ...
            even the length of the note. More importantly, we invite the community to create with us.
          </p>
        </div>
      </div>
    </Layout>
