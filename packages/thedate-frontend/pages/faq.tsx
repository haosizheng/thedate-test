    ...
    <Layout>
      <div className="content">
        ...
        <div className="faq__item">
          ...
          <p>Since <a href="https://en.wikipedia.org/wiki/Unix_time">Unix Epoch</a>, one The Date was generated for each day. </p>
        ...
        <div className="faq__item">
          ...
          <p>
            For claimed past The Date, you can trade it on the secondary market <a href={openseaLink}>OpenSea</a>.
          </p>
          <p>
            For unclaimed past The Date, you can <a href={`${etherscanLinkOfToken}#writeContract`}>claim</a> it directly in the contract. 
            Select an available date to claim, and note that only one The Date will be available for each date. 
            Each claim costs Ξ 0.01.
          </p>
          <p>
        ...
        <div className="faq__item">
          ...
          <p>
            ...
            However, you have to pay Ξ 1 to <a href={`${etherscanLinkOfToken}#writeContract`}>erase</a> the existing engraved note before a new one can be engraved. 
          </p>
        </div>
        ...
        <div className="faq__item">
          ...
          <p>
            You are free to use The Date in anyway you want. 
        ...
        <div className="faq__item">
          ...
          <p>
            ...
            The Date DAO  members can vote on Snapshot to decide where this project to go.
            For example, a proposal can be promoted to <a href=""> setReservedPrice()</a>, 
            <a href=""> setMinimumBps()</a>
            <a href=""> setReservedPrice()</a>
            <a href=""> setReservedPrice()</a>
            the minimal increase percentage for auction, the note-engraving price, or the note-erasing price, 
            even the length of the note. 
            More importantly, we invite the community to create with us.
          </p>
        </div>
      </div>
    </Layout>
