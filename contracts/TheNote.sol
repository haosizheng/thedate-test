...
contract TheNote is ERC721Enumerable, AccessControl, WithFoundation, WithRoyalty, MintedByFixedPrice {
    ...
    {
        return ERC721Enumerable.supportsInterface(interfaceId) || WithRoyalty.supportsInterface(interfaceId) || AccessControl.supportsInterface(interfaceId);
    }
    ...
    function payToMint(string memory note) 
        external payable validNote(note) 
